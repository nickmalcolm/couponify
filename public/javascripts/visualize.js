...
$.fn.visualize = function(options, container){
    return $(this).each(function(){
        ...
        var o = $.extend({
            ...
            rowFilter: ' ',
            colFilter: ' ',
            colors: ['#26a4ed','#ee8310','#666699','#92d5ea','#be1e2d','#8d10ee','#5a3b16','#f45a90','#e9e744'],
            textColors: [], //corresponds with colors array. null/undefined items will fall back to CSS
            parseDirection: 'x', //which direction to parse the table data
            pieMargin: 20, //pie charts only - spacing around pie
            pieLabels: 'both', //also avaiable: percentage, value
            pieLabelPos: 'inside',
        ...
        var createChart = {
            pie: function(){    
                ...
                $.each(memberTotals, function(i){
                    ...
                    if(percentage){
                        if(o.pieLabels == "percentage" ){
                          var labelval = percentage + '%';
                        }else if(o.pieLabels == "value"){
                          var labelval = this;
                        }else if(o.pieLabels == "both"){
                          var labelval = percentage + '% (' + this + ")";
                        }
